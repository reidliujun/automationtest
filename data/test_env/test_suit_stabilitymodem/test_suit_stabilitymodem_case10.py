...
class test_suit_stabilitymodem_case10(TestCaseBase):
...
#        mt_trigger_service_sms('ludf134@#$%_343', '15900564675', 30, 15, count=2, msg_type=0, wap_url=" ")
        ...
        try:
            ...
            if SC.PUBLIC_DSDS:
                ...
                #===================================================================
                    mt_trigger_service_sms(sms_text, sms_num2, 60, 15, count=1, msg_type=0, wap_url=" ")
                    mt_trigger_service_call(sms_num2, 10, 10, 60, num_of_calls=1, count_off=True)
                    sleep(60)
            else:
