...
class test_suit_z_case1(TestCaseBase):
    '''
...
#        settings.set_default_sms(0)
        start_activity('com.quicinc.fmradio', 'com.quicinc.fmradio.FMRadio')
        print(11)
        #launcher.launch_from_launcher('fmradio')
        print(22)
        launcher.launch_from_launcher('youku')
        print(33)
        launcher.launch_from_launcher('camera')
        goback()
        sleep(240)
        print(240)
#        search_view_by_id("incomingCallWidget")        
#        register_update_watcher(appName, className, idType,id,action)
#        register_update_watcher(launcher.get_value('weibo'), VIEW_TEXT_VIEW, ID_TYPE_TEXT, weibo.get_value("new_version"), ACTION_DRAG)
#########scenerios2###############################
#        print(8)
#        launcher.launch_from_launcher('settings')
#        settings.enable_wifi(SC.PUBLIC_WIFI_NAME, SC.PUBLIC_WIFI_PASSWORD_SEQUENCE)
...
#       # launcher.launch_from_launcher('fmradio')
#        print(22)
#        kill_by_name('com.youku.phone')
#        print(33)
#        kill_by_name('com.android.gallery3d')
#        goback()
#        sleep(240)
#        print(240)
#########scenerios3###############################
